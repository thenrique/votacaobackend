...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, ResultadoDto> resultadoVotacaoProducerFactory() {
        Map<String, Object> configProps = new HashMap<>();
        configProps.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "broker-kafka:29092");
    ...
    @Bean
    public KafkaTemplate<String, ResultadoDto> kafkaTemplate() {
